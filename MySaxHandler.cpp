...
void MySaxHandler::characters(const XMLCh *const chars, const XMLSize_t length)
{
...
void MySaxHandler::endEntity(const XMLCh* const name)
{
    char* message = XMLString::transcode(name);
...
void MySaxHandler::endElement (const XMLCh *const uri, const XMLCh *const localname, const XMLCh *const qname)
{
